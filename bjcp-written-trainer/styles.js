const styles = [
 {
    ...
    bitterness: { anchor: "Firm Bitter", min: 22, max: 40, unit: "IBU" },
    body: { anchor: "Medium-Light", min: 1.008, max: 1.013, unit: "FG" },
    carbonation: { anchor: "Medium-High", min: null, max: null, unit: null, text: "Medium-light body. Medium to high carbonation." },
    color: { anchor: "Pale Gold", min: 2, max: 5, unit: "SRM" },
...

{
    code: "4A",
    name: "Munich Helles",
    strength: { anchor: "Standard", min: 4.7, max: 5.4, unit: "%" },
    bitterness: { anchor: "Slightly Malt-forward", min: 16, max: 22, unit: "IBU" },
    body: { anchor: "Medium", min: 1.006, max: 1.012, unit: "FG" },
    carbonation: { anchor: "Moderate", min: null, max: null, unit: null, text: "Medium body. Medium carbonation. Smooth, well-lagered character." },
    color: { anchor: "Pale Gold", min: 3, max: 5, unit: "SRM" },
    og: { min: 1.044, max: 1.048, unit: "OG" },
    foundationEligible: true,
    comparisonEligible: true,
    recipeEligible: true,
    core: true,
...

{
    code: "7A",
    name: "Vienna Lager",
    strength: { anchor: "Standard", min: 4.7, max: 5.5, unit: "%" },
    bitterness: { anchor: "Balanced", min: 18, max: 30, unit: "IBU" },
    body: { anchor: "Medium", min: 1.010, max: 1.014, unit: "FG" },
    carbonation: { anchor: "Moderate", min: null, max: null, unit: null, text: "Medium-light to medium body, with a gentle creaminess. Moderate carbonation. Smooth." },
    color: { anchor: "Amber", min: 9, max: 15, unit: "SRM" },
    og: { min: 1.048, max: 1.055, unit: "OG" },
    foundationEligible: true,
    comparisonEligible: true,
    recipeEligible: true,
    core: true,
...

{
    ...
    color: { anchor: "Amber", min: 8, max: 17, unit: "SRM" },
    og: { min: 1.054, max: 1.060, unit: "OG" },
    foundationEligible: true,
    comparisonEligible: true,
    recipeEligible: true,
    core: true,
    ...
    
{
    ...
    bitterness: { anchor: "Hop-forward", min: 20, max: 35, unit: "IBU" },
    body: { anchor: "Medium-Light", min: 1.008, max: 1.014, unit: "FG" },
    carbonation: { anchor: "Moderate", min: null, max: null, unit: null, text: "Moderate carbonation." },
    color: { anchor: "Gold", min: 3, max: 6, unit: "SRM" },
    og: { min: 1.028, max: 1.044, unit: "OG" },
    foundationEligible: true,
    comparisonEligible: true,
    recipeEligible: true,
    core: true,
...

{
    ...
    strength: { anchor: "Standard", min: 4.2, max: 5.8, unit: "%" },
    bitterness: { anchor: "Firm Bitter", min: 30, max: 45, unit: "IBU" },
    body: { anchor: "Medium", min: 1.013, max: 1.017, unit: "FG" },
    carbonation: { anchor: "Medium-High", min: null, max: null, unit: null, text: "Medium body. Medium to high carbonation." },
    color: { anchor: "Gold", min: 3.5, max: 6, unit: "SRM" },
...

{
    code: "8A",
    name: "Munich Dunkel",
    strength: { anchor: "Standard", min: 4.5, max: 5.6, unit: "%" },
    bitterness: { anchor: "Slightly Malt-forward", min: 18, max: 28, unit: "IBU" },
    body: { anchor: "Medium", min: 1.010, max: 1.016, unit: "FG" },
    carbonation: { anchor: "Moderate", min: null, max: null, unit: null, text: "Medium body. Moderate carbonation." },
    color: { anchor: "Brown", min: 14, max: 28, unit: "SRM" },
...

{
    ...
    color: { anchor: "Brown", min: 6, max: 25, unit: "SRM" },
    og: { min: 1.072, max: 1.112, unit: "OG" },
    foundationEligible: true,
    comparisonEligible: true,
    recipeEligible: true,
    core: true,
...
},
{
    ...
    bitterness: { anchor: "Firm Bitter", min: 25, max: 40, unit: "IBU" },
    body: { anchor: "Medium-Light", min: 1.008, max: 1.012, unit: "FG" },
    carbonation: { anchor: "Low", min: null, max: null, unit: null, text: "Low carbonation, although bottled examples can have moderate carbonation." },
    color: { anchor: "Amber", min: 8, max: 16, unit: "SRM" },
    og: { min: 1.040, max: 1.048, unit: "OG" },
    foundationEligible: true,
    comparisonEligible: true,
    recipeEligible: true,
    core: true,
...

{
    ...
    color: { anchor: "Copper", min: 8, max: 18, unit: "SRM" },
    og: { min: 1.048, max: 1.060, unit: "OG" },
    foundationEligible: true,
    comparisonEligible: true,
    recipeEligible: true,
    core: true,
...

{
    ...
    color: { anchor: "Gold", min: 3, max: 6, unit: "SRM" },
    og: { min: 1.038, max: 1.054, unit: "OG" },
    foundationEligible: true,
    comparisonEligible: true,
    recipeEligible: true,
    core: true,
...

{
    ...
    bitterness: { anchor: "Hop-forward", min: 30, max: 50, unit: "IBU" },
    body: { anchor: "Medium", min: 1.010, max: 1.015, unit: "FG" },
    carbonation: { anchor: "Medium-High", min: null, max: null, unit: null, text: "Moderate to high carbonation." },
    color: { anchor: "Gold", min: 5, max: 10, unit: "SRM" },
...

{
    ...
    carbonation: { anchor: "Low-Moderate", min: null, max: null, unit: null, text: "Full to very full body. Low to moderate carbonation." },
    color: { anchor: "Black", min: 30, max: 40, unit: "SRM" },
...

{
    ...
    carbonation: { anchor: "Low-Moderate", min: null, max: null, unit: null, text: "Medium-full to full body. Low to moderate carbonation." },
    color: { anchor: "Black", min: 30, max: 40, unit: "SRM" },
    og: { min: 1.044, max: 1.060, unit: "OG" },
    foundationEligible: true, comparisonEligible: true, recipeEligible: true, core: true, anchorStatus: "approved"
},
